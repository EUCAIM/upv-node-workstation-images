...
docker run -d --rm -p 15900:5900 -p 3322:22 ^
           ...
           -e OIDC_URL="https://chaimeleon-eu.i3m.upv.es/auth/realms/CHAIMELEON/protocol/openid-connect/token" ^
           -e OIDC_GUACAMOLE_CLIENT_ID="guacamole" ^
           -e GUACD_HOST="10.98.124.259" ^
           -e SSH_ENABLE_PASSWORD_AUTH=true  ^
           -e GATEWAY_PORTS=true ^
           -e TCP_FORWARDING=true ^
           --name testing01 ^
           chaimeleon-eu.i3m.upv.es:10443/chaimeleon-library/ubuntu_python_tensorflow_gpu_desktop_vnc_sshd:1.1
...
pause
docker rmi chaimeleon-eu.i3m.upv.es:10443/chaimeleon-library/ubuntu_python_tensorflow_gpu_desktop_vnc_sshd:1.1
docker rmi chaimeleon-eu.i3m.upv.es:10443/chaimeleon-library/ubuntu_python_tensorflow_gpu_desktop_vnc:1.1
